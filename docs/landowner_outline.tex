...
{\Large{\textbf{Family Forest Carbon Program}}}
  ...
  \item That is why the decisions you make about managing your land can be a major positive influence on our environment and benefit forest income, wildlife, provide clean water, establish a resilient ecosystem and mitigate climate change. %%How you manage your land also plays a role.
    % TODD: I think #4 is a key piece. Many landowners will think “If forests are so important, why not just leave them be?” I see two ways of approaching this: for landowners already actively managing or thinking about it, they can see that thoughtful and intentional management doesn’t need to be at odds with climate mitigation. For those that aren’t thinking about active management, this program might be an entry point to thinking about how management can benefit other goals they have for their forest (income, wildlife, water, RESILIENCE) and may help to store addition carbon in the forest relative to what the average landowner might do.  
  \end{itemize}
...
{\large{\textbf{\textcolor{DarkGreen}{FOREST RESILIENCE:}}}}\\
  Our forests are vulnerable to land conversion, invasive plants, insects, and diseases, heavy deer and moose browsing and climate change. This is why the role of management is so crucial. Your forest provides clean water, wildlife habitats, recreational opportunities and forest products while also sequestering carbon from the atmostphere. By managing your forest and keeping your forest a forest, it will continue to be resilient and help reduce the risks of climate change. 
  \end{minipage}}}
\end{centering}
...
{\Large{\textbf{The Family Forest Carbon Practices}}}
  ...
  \item By joining the Family Forest Carbon Program, you will become part of a team which includes: 
    \begin{enumerate}
    \item A Forester: who can speak with you and visit your land to provide advice on management options and program opportunities. A forester can help you design a plan that fits your values and most makes sense for your landscape.
    \item A Logger/Harvester: who will mark trees and help carry out the management plan that best suits you and your forest's needs.
  ...
  \item You and your team will then develop a forest management plan that follows one of the 10 possible practices: (please note the first four practices are not eligible for FFCP payments)
